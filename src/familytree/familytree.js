...
FamilyTree._defaultConfig = function(e) {
    return {
        ...
        editForm: {
            readOnly: !1,
            titleBinding: "Họ và tên",
            photoBinding: "Link hình ảnh",
            addMore: "Thêm các mục khác",
            addMoreBtn: "Thêm",
            addMoreFieldName: "Tên mục",
